...
export default function PreOrderPage() {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#ffe1ea] via-[#fff7f0] to-white" aria-hidden />
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 text-sm text-[var(--color-choco)]/70">
              <div className="rounded-3xl bg-white/90 p-5 shadow-md shadow-[#f0658315]">
          ...
          <div className="flex-1">
            <div className="rounded-[46%] bg-gradient-to-br from-white via-[#ffe6f5] to-[#ffe1c9] p-10 shadow-2xl shadow-[#f0658325] text-center">
      ...
      <section className="relative max-w-screen-xl mx-auto px-6 lg:px-10 pb-20 grid gap-8 lg:grid-cols-[2fr_1fr]">
        <form
          ...
          className="rounded-3xl bg-white/90 p-8 shadow-xl shadow-[#f0658315] space-y-6"
        >
          <div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center justify-center rounded-full bg-[var(--color-rose)] px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-[#f0658333] transition hover:bg-[var(--color-rose-dark)] disabled:cursor-not-allowed disabled:opacity-60"
            >
        ...
        <aside className="rounded-3xl bg-white/80 p-8 shadow-xl shadow-[#f0658315] space-y-6">
          <div>
          ...
          <div className="rounded-3xl bg-gradient-to-r from-[#f06583] to-[#f6c34a] px-5 py-6 text-white shadow-lg shadow-[#f0658333]">
